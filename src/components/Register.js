...
class Register extends React.Component {
	...
	onNameChange = (event) => {
		...
		onSubmitSignIn = () => {
		fetch('https://floating-chamber-91954.herokuapp.com/register',{
			method: 'post',
	...
	render() {
		...
		<main className="pa4 middle black-80">
		  <div>
		    <fieldset id="sign_up" className="ba b--transparent ph0 mh0">
		      ...
		      <div className="mt3">
		        ...
		        className="b pa2 input-reset ba bg-transparent hover-bg-black hover-white w-100"  name="password"  id="password" />
		      </div>
